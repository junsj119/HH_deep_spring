/*
* (domain)usersTest -> ProdcutTest ->   mockobject(repo, service 다 만듦) -> service(Mockito 사용) -> integration(스프링 부트를 이용한 통합 테스트)
*
* -> MVC
* */
...
class ProductTest {
    ...
    class CreateUserProduct {
        ...
        void createProduct_Normal() {
            ...
            // then
            assertNull(product.getId());    //NULL이어야 한다.
        ...
        class FailCases {
            ...
            class userId {
                ...
                void fail1() {
                    ...
                    // when
                    //userId가 NULL일 때 product 단에서 예외처리가 되는지 확인. exception에 prosuct에서 발생한 예외 string이 담긴다.
